...
function Navbar () {
    ...
    return (
        <div>
            {
                showTab ?
                    <div className='z-10 px-4 h-screen bg-white space-y-10 w-70'>
                        ...
                        <div className='flex-1 flex flex-col items-center justify-center space-y-2 font-semibold text-black'>
                            <Link onClick={() => {setPageURL("HOME");}} to='/'className={`${pageURL === 'HOME' ? "bg-[#FFEA00] rounded-lg": " "} flex items-center space-x-4 justify-start w-full py-2`}>
                            ...
                            <Link onClick={() => {setPageURL("VALIDATORS");}} to='/validators' className={`${pageURL === 'VALIDATORS' ? "bg-[#FFEA00] rounded-lg": " "} flex items-center space-x-4 justify-start w-full py-2`}>
                                <div class={`${pageURL === 'VALIDATORS' ? "bg-opacity-5": " "} p-3 bg-white rounded-lg justify-center items-center gap-2.5 flex `}>
                                    <div class="group-hover:text-v2-primary fill-current text-v2-lily/[.75]">
                                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" focusable="false" class="chakra-icon css-idgmmw" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                    </div>
                                </div>
                                <div>Validators</div>
                            </Link>
                            <Link onClick={() => {setPageURL("BLOCKS");}} to='/blocks' className={`${pageURL === 'BLOCKS' ? "bg-[#FFEA00] rounded-lg": " "} flex items-center space-x-4 justify-start w-full py-2`}>
                            ...
                            <Link onClick={() => {setPageURL("SEARCH");}} to='/search' className={`${pageURL === 'SEARCH' ? "bg-[#FFEA00] rounded-lg": " "} flex items-center space-x-4 justify-start w-full py-2`}>
